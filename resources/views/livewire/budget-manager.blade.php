<div style="overflow-x:hidden; width:100%; box-sizing:border-box;">
    ...
    <div style="display:grid;
        ...
        <div wire:key="budget-{{ $budget->id }}"
            ...
            <div style="margin-bottom:12px;">
                ...
                <input type="number"
                       wire:model.live="editLimitAmount"
                       step="0.01"
            ...
            <div style="display:flex; gap:8px;">
                <button wire:click="updateBudget"
                        style="flex:1; padding:8px; background:#1B6B4A;
                ...
                <button wire:click="cancelEdit"
                        style="flex:1; padding:8px; background:#f1f5f9;
            ...
            <div style="display:flex; justify-content:space-between;
                ...
                <div style="min-width:0; flex:1; padding-right:8px;">
                    ...
                    <div style="font-size:12px; color:#94a3b8;">
                        {{ $months[str_pad($budget->period_month,
                            2, '0', STR_PAD_LEFT)] ?? '' }}
                        {{ $budget->period_year }}
                    </div>
                </div>
                <div style="display:flex; gap:2px; flex-shrink:0;">
                    <button wire:click="startEdit({{ $budget->id }})"
                            ...
                            onmouseover="this.style.color='#1B6B4A';
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr 1fr;
                ...
                <div style="text-align:center; background:#f0fdf4;
                    ...
                    <div style="font-size:12px; font-weight:700;
                                color:#1B6B4A; overflow:hidden;
                                text-overflow:ellipsis; white-space:nowrap;">
                        {{ currency_symbol() }}{{ number_format($budget->limit_amount, 0) }}
                    </div>
                </div>
                ...
                <div style="text-align:center; border-radius:8px;
                    ...
                    <div style="font-size:12px; font-weight:700;
                                ...
                                color:{{ $remaining < 0
                                    ? '#ef4444' : '#1B6B4A' }};">
                        {{ $remaining < 0 ? '-' : '' }}{{ currency_symbol() }}{{ number_format(abs($remaining), 0) }}
                    </div>
                </div>
    ...
    <div style="background:white; border-radius:12px; padding:48px 24px;
                ...
                box-shadow:0 1px 4px rgba(0,0,0,0.06);
                margin-bottom:20px;">
        <svg style="width:48px; height:48px; margin:0 auto 16px;
                    color:#e2e8f0;"
        ...
        <p style="font-size:15px; font-weight:600; color:#64748b;
                  margin:0 0 6px;">
            No budgets yet
        </p>
        ...
        <button wire:click="openAddModal"
                style="padding:9px 20px; background:#1B6B4A;
                       color:white; border:none; border-radius:8px;
    ...
    <div style="position:fixed; inset:0; background:rgba(0,0,0,0.5);
        ...
        <div style="background:white; border-radius:16px; padding:24px;
            ...
            <div style="display:flex; justify-content:flex-end; gap:10px;">
                <button wire:click="$set('showAddModal', false)"
                        style="padding:9px 18px; background:#f1f5f9;
                ...
                <button wire:click="saveBudget"
                        ...
                        style="padding:9px 18px; background:#1B6B4A;
                               color:white; border:none;
                               border-radius:8px; font-size:14px;
                               font-weight:500; cursor:pointer;">
                    <span wire:loading.remove wire:target="saveBudget">
                        Save Budget
                    </span>
